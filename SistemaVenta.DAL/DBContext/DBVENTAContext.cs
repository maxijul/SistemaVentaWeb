...
public partial class DBVENTAContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CC3AC7D76");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FAFDDBDA3");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483323C36BF");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1072FF12CF4");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E837025DF");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1323C18FFBE");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76AAD6431F");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D85590AE2F");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEFF231F8A");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A61723D737");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614C0982BED");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__412EB0B6");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Venta)
                .HasForeignKey(d => d.IdUsuario)
                .HasConstraintName("FK__Venta__idUsuario__4222D4EF");
        });
